...
% GraphTucker decomposition results to analyze
...
pct_list = [1 2 5 10 25 100]; % top n% to test
...
auc_mat = zeros(rank_list(3), num_regions); % AUCs
ed_mat = zeros(rank_list(3), num_regions); % euclidean distances
